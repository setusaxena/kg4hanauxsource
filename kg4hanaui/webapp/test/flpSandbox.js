		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "KG4HANAUI",
									"targetURL": "#comsapkg4hanakg4hanaui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapkg4hanakg4hanaui-display": {
								"semanticObject": "comsapkg4hanakg4hanaui",
								"action": "display",
								"description": "KG4HANAUI Fiori UI",
								"title": "KG4HANAUI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kg4hana.kg4hanaui",
									"url": sap.ui.require.toUrl("com/sap/kg4hana/kg4hanaui")
								}
							}
						}
					}
